...
namespace Broker
{
    public class Broker : BaseProcess, IBroker
    {
                        ...
                        if (!child.Key.Equals(fromSite))
                        {
                            ...
                            if (this.LoggingLevel == LoggingLevel.Full)
                            {
                                thread =
                                    new Thread(
                                        () =>
                                            PuppetMaster.DeliverLog("BroEvent " + ProcessName + ", " + origin + ", " +
                                                                    topic));
                                thread.Start();
                            }
                        }
        ...
        public override
            ...
            /// <param name="sequenceNumber"></param>
        public
            void AddLocalSubscription 
            (string process, string topic, string siteName)
            {
        ...
        public
            void UpdatePublisherSequenceNumber 
            (string process, int sequenceNumber)
            {
        ...
        public
            void ProcessFrozenListCommands 
            ()
            {
                string[] command;
        ...
        private
            void ProcessInternalCommandOrMessage 
            (string[]
            command)
            {
                switch (command[0])
        ...
        private
            bool PublicationReceived 
            (string origin, string topic, string publication, string fromSite,
                int sequenceNumber)
            {
